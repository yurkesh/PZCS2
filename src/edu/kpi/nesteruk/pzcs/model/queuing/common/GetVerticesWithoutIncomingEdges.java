...
public class GetVerticesWithoutIncomingEdges {
    ...
    public static <N extends Node, L extends Link<N>> Collection<N> getFirstTopologicalLevel(GraphModelBundle<N, L> graphBundle) {
        return getFirstTopologicalLevel(graphBundle.getNodesMap(), graphBundle.getLinksMap());
    }
